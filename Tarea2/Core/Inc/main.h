...
/* Private defines -----------------------------------------------------------*/
#define Boton0_Pin GPIO_PIN_13
#define Boton0_GPIO_Port GPIOC
#define Boton0_EXTI_IRQn EXTI13_IRQn
...
#define Boton1_Pin GPIO_PIN_9
#define Boton1_GPIO_Port GPIOC
#define Boton1_EXTI_IRQn EXTI9_IRQn
